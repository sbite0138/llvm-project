//===-- MtGAsmPrinter.cpp - MtG LLVM assembly writer ----------------===//
//
...
// of machine-dependent LLVM code to the MtG assembly language.
//
//===----------------------------------------------------------------------===//

#include "MCTargetDesc/MtGInstPrinter.h"
#include "MtG.h"
...
void MtGAsmPrinter::EmitInterruptVectorSection(MachineFunction &ISR) {
...
bool MtGAsmPrinter::runOnMachineFunction(MachineFunction &MF) {
...
extern "C" LLVM_EXTERNAL_VISIBILITY void LLVMInitializeMtGAsmPrinter() {
  RegisterAsmPrinter<MtGAsmPrinter> X(getTheMtGTarget());
}
