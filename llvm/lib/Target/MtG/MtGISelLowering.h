//===-- MtGISelLowering.h - MtG DAG Lowering Interface ----*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the interfaces that MtG uses to lower LLVM code into a
// selection DAG.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_MtG_MtGISELLOWERING_H
#define LLVM_LIB_TARGET_MtG_MtGISELLOWERING_H
...
namespace llvm {
  namespace MtGISD {
    enum NodeType : unsigned {
      ...
      /// MtG conditional branches. Operand 0 is the chain operand, operand 1
  ...
  class MtGSubtarget;
  class MtGTargetLowering : public TargetLowering {
  public:
    explicit MtGTargetLowering(const TargetMachine &TM,
    ...
    /// necessarily apply to truncate instructions. e.g. on mtg, all
