...
MtGInstrInfo::MtGInstrInfo(MtGSubtarget &STI)
  : MtGGenInstrInfo(MtG::ADJCALLSTACKDOWN, MtG::ADJCALLSTACKUP),
    RI() {}
...
void MtGInstrInfo::storeRegToStackSlot(
  ...
  if (RC == &MtG::GR16RegClass)
    BuildMI(MBB, MI, DL, get(MtG::MOV16mr))
      .addFrameIndex(FrameIdx).addImm(0)
      .addReg(SrcReg, getKillRegState(isKill)).addMemOperand(MMO);
  else if (RC == &MtG::GR8RegClass)
    BuildMI(MBB, MI, DL, get(MtG::MOV8mr))
      .addFrameIndex(FrameIdx).addImm(0)
      .addReg(SrcReg, getKillRegState(isKill)).addMemOperand(MMO);
  else
...
void MtGInstrInfo::copyPhysReg(MachineBasicBlock &MBB,
  ...
  unsigned Opc;
  if (MtG::GR16RegClass.contains(DestReg, SrcReg))
    Opc = MtG::MOV16rr;
  else if (MtG::GR8RegClass.contains(DestReg, SrcReg))
    Opc = MtG::MOV8rr;
  else
