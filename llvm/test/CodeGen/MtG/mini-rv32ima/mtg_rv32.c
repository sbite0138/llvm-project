...
/* Default offset: the standard mini-rv32ima address space. ADD_MACRO
   already includes mod 2^32, so uint32_t overflow is handled correctly. */
...
/* RV32I test ROM: 13 tests (A-M), outputs '!' and poweroff on failure.
   Tests: ADDI, ADD, SUB, ANDI, ORI, XORI, SLLI, SRLI, SW/LW,
          BEQ, BNE, JAL, SLT.
   SW/LW test uses address 0x80000000+800 (within RAM image).
   Expected output on success: "ABCDEFGHIJKLM" (with '*' artifacts) */
static const uint32_t test_rom[] = {
    ...
    0x80000137,0x32010113,0x02A00513,0x00A12023,0x00000513,
    0x00012503,0x02A00393,0x00750863,0x02100313,0x0062A023,
    0x111002B7,0x0072A023,0x100002B7,0x04900313,0x0062A023,
    0x00500513,0x00500593,0x00B50463,0x06300513,0x00500393,
    0x00750863,0x02100313,0x0062A023,0x111002B7,0x0072A023,
    0x100002B7,0x04A00313,0x0062A023,0x00500513,0x00300593,
    0x00B51463,0x06300513,0x00500393,0x00750863,0x02100313,
    0x0062A023,0x111002B7,0x0072A023,0x100002B7,0x04B00313,
    0x0062A023,0x0080056F,0x06300513,0x02A00513,0x02A00393,
    0x00750863,0x02100313,0x0062A023,0x111002B7,0x0072A023,
    0x100002B7,0x04C00313,0x0062A023,0xFFB00513,0x00300593,
    0x00B52533,0x00100393,0x00750863,0x02100313,0x0062A023,
    0x111002B7,0x0072A023,0x100002B7,0x04D00313,0x0062A023,
